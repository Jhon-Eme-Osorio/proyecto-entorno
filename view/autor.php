                                                            ...
                                                            <form action="?view=guardarAutor" method="post">
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control"
                                                                        name="nombre-autor" id="nombre-autor"
                                            ...
                                            <table class="table table-hover text-center">
                                                ...
                                                <?php foreach ($this->model->listaAutor() as $key): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $key->Fecha_nacimiento; ?>
                                                        </td>
                                                        <td>
                                                            <a href="?view=idAutor&Id_autor=<?php echo $key->Id_autor ?>"
                                                                class="link-dark" title="Editar"><i
                                                                    class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                                            <a href="?view=borrarAutor&Id_autor=<?php echo $key->Id_autor; ?>"
