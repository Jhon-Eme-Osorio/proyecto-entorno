                                                ...
                                                <div class="card-body">
                                                    <form action="?view=guardarEditorial" method="post">
                                                        <div class="form-floating mb-3">
                                                            <input type="hidden" class="form-control" name="Id_editorial"
                                                                id="Id_editorial"
                                                                value="<?php echo $editorial->Id_editorial; ?>" required>
                                                            <input type="text" class="form-control" name="nombre-editorial"
                                                                id="nombre-editorial" placeholder="Nombre"
                                                                value="<?php echo $editorial->Nombre; ?>" required>
                                                            <label for="nombre-editorial">Nombre</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input type="number" class="form-control"
                                                                name="telefono-editorial" id="telefono-editorial"
                                                                placeholder="Telefono"
                                                                value="<?php echo $editorial->Telefono; ?>" required>
                                                            <label for="telefono-editorial">Telefono</label>
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="?view=editorial" class="btn btn-secondary">Cancelar</a>&nbsp;
                                                <button type="submit" class="btn btn-primary"
                                                    name="Guardar-categoria">Guardar</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
