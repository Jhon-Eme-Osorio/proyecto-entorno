                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="card-body">
                                                    <form action="?view=guardarAutor" method="post">
                                                        <div class="form-floating mb-3">
                                                            <input type="hidden" class="form-control" name="Id_autor"
                                                                id="Id_autor"
                                                                value="<?php echo $autor->Id_autor; ?>" required>
                                                            <input type="text" class="form-control" name="nombre-autor"
                                                                id="nombre-autor" placeholder="nombre"
                                                                value="<?php echo $autor->Nombre; ?>" required>
                                                            <label for="nombre-autor">Nombre</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control"
                                                                name="apellido-autor" id="apellido-autor"
                                                                placeholder="apellido"
                                                                value="<?php echo $autor->Apellido; ?>" required>
                                                            <label for="apellido-autor">Apellido</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input type="date" class="form-control"
                                                                name="fecha-nacimiento-autor"
                                                                id="fecha-nacimiento-autor"
                                                                placeholder="fecha-nacimiento"
                                                                value="<?php echo $autor->Fecha_nacimiento; ?>"
                                                                required>
                                                            <label for="fecha-nacimiento-autor">Fecha
                                                                Nacimiento</label>
                                                        </div>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <a href="?view=autor" class="btn btn-secondary">Cancelar</a>&nbsp;
