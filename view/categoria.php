                                                            ...
                                                            <form action="?view=guardarCategoria" method="post">
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control"
                                                                        name="nombre-categoria" id="nombre-categoria"
                                                                ...
                                                                <div class="form-floating mb-3">
                                                                    ...
                                                                    <label
                                                                        for="descripcion-categoria">Descripcion</label>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                            ...
                                            <table class="table table-hover text-center">
                                                ...
                                                <?php foreach ($this->model->listaCategorias() as $key): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="?view=idCategoria&Id_categoria=<?php echo $key->Id_categoria ?>"
                                                                class="link-dark" title="Editar"><i
                                                                    class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                                            <a href="?view=borrarCategoria&Id_categoria=<?php echo $key->Id_categoria; ?>"
