                                            ...
                                            <table class="table table-hover text-center">
                                                ...
                                                <?php foreach ($this->model->listaCliente() as $key): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="?view=idCliente&Id_cliente=<?php echo $key->Id_cliente ?>"
                                                                class="link-dark" title="Editar"><i
                                                                    class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                                                            <a href="?view=borrarCliente&Id_cliente=<?php echo $key->Id_cliente; ?>"
