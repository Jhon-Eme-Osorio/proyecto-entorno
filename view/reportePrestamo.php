...
$pdf->Cell(80, 6, 'LISTA DE PRESTAMOS', 0, 0, 'C');
...
$pdf->Cell(52, 6, 'Libro', 1, 0, 'C', 1);
$pdf->Cell(40, 6, 'Fecha Prestamo', 1, 0, 'C', 1);
$pdf->Cell(40, 6, 'Fecha Devolucion', 1, 0, 'C', 1);
...
foreach ($prestamo as $key):
    ...
    $pdf->Cell(40, 6, $key->Fecha_prestamo, 1, 0, 'C');
    $pdf->Cell(40, 6, ($key->Fecha_devolucion), 1, 0, 'C');
    $pdf->Cell(25, 6, ($nombreCompleto), 1, 0, 'C');
...
$pdf->Output('Reporte_Prestamo_' . date('d_m_y') . '.pdf', 'I');
