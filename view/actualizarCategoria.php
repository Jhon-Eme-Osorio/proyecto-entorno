                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="card-body">
                                                    <form action="?view=guardarCategoria" method="post">
                                                        <div class="form-floating mb-3">
                                                            <input type="hidden" class="form-control" name="Id_categoria"
                                                                id="Id_categoria"
                                                                value="<?php echo $categoria->Id_categoria; ?>" required>
                                                            <input type="text" class="form-control" name="nombre-categoria"
                                                                id="nombre-categoria" placeholder="Nombre"
                                                                value="<?php echo $categoria->Nombre; ?>" required>
                                                            <label for="nombre-categoria">Nombre</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control"
                                                                name="descripcion-categoria" id="descripcion-categoria"
                                                                placeholder="Descripcion"
                                                                value="<?php echo $categoria->Descripcion; ?>" required>
                                                            <label for="descripcion-categoria">Descripcion</label>
                                                        </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <a href="?view=categoria" class="btn btn-secondary">Cancelar</a>&nbsp;
