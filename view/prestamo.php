                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="?view=guardarPrestamo" method="post">
                                                                <div class="form-floating mb-3">
                                                                    <input type="date" class="form-control"
                                                                        name="fecha-prestamo" id="fecha-prestamo"
                                                                        placeholder="" required>
                                                                    <label for="fecha-prestamo">Fecha Prestamo</label>
                                                                </div>
                                                                <div class="form-floating mb-3">
                                                                    <input type="date" class="form-control"
                                                                        name="fecha-devolucion" id="fecha-devolucion"
                                                                ...
                                                                <div class="form-floating mb-3">
                                                                    <select class="form-select" name="libro" required>
                                                                        ...
                                                                        <?php foreach ($this->model->listaLibros() as $key): ?>
                                                                            <option value="<?php print($key->Id_libro); ?>">
                                                                                <?php print($key->Titulo); ?>
                                                                            </option>
                                                                ...
                                                                <div class="form-floating mb-3">
                                                                    <select class="form-select" name="cliente" required>
                                                                        ...
                                                                        <?php foreach ($this->model->listaCliente() as $key): ?>
                                                                            <option
                                                                                value="<?php print($key->Id_cliente); ?>">
                                        ...
                                        <div class="table-wrapper">
                                            <table class="table table-hover text-center">
                                                ...
                                                <?php $devolver = $this->devolver(); foreach ($this->model->listaPrestamo() as $key): ?>
                                                    <tr>
                                                        <td>
                                                            <?php echo $key->Titulo; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $key->Fecha_prestamo; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $key->Fecha_devolucion; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $key->Nombre; ?>
                                                        ...
                                                        <td>
                                                            <?php if($key->Estado == 1){?>
                                                            <span class="badge text-bg-danger">PRESTADO</span><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                                            
                                                            <a href="?view=devolver&Id_prestamo=<?php echo $key->Id_prestamo ?>&Id_libro=<?php echo $key->Id_libro ?>"
                                                                class="link-dark" title="Devolver"><i class="fa-solid fa-arrow-rotate-left fa-xl"></i></a>
                                                                    <?php }else if($key->Estado == 0) {?> <span class="badge text-bg-success">DEVUELTO</span>
                                                                        <span>&nbsp;&nbsp;&nbsp;&nbsp;</span> <?php }; ?>
                                                        </td>
